...
setup(
    name = 'modules',  # How you named your package folder (MyLib)
    ...
    url = 'https://github.com/Maaaax2021/python_modules',  # Provide either the link to your github or to your website
    download_url = 'https://github.com/Maaaax2021/python_modules/archive/v_01.tar.gz',  # I explain this later on
